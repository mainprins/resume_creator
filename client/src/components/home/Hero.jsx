            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <a href="https://prebuiltui.com">
                       ...
                       <span className='text-2xl font-semibold tracking-wider'>Meroresume<span className='text-green-600'>.</span></span>
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <a href="#callToAction" className="text-white">Contact</a>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        ...
                        Create wonderful resume with <span className=" bg-gradient-to-r from-green-700 to-green-600 bg-clip-text text-transparent text-nowrap">AI </span> Features.

                    </h1>


                    <p className="max-w-md text-center text-base my-7">Explore powerful tools to craft your standout resume effortlessly!</p>
                    ...
                    <div className="flex items-center gap-4 ">
                        ...
                        <Link to={'/app?state=login'} className="bg-green-500 hover:bg-green-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-green-400 flex items-center transition-colors">
