...
const Footer = () => {
    return (
        <>
            ...
            <footer className="flex mt-10 flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200 to-white">

                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">

                    <a href="https://prebuiltui.com">

                        <span className='text-2xl font-semibold text-slate-800 tracking-wider'>Meroresume<span className='text-green-600'>.</span></span>
